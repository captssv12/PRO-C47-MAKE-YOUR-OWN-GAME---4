...
bg.velocityX=-2
 ...
 mario = createSprite(100,100,10,40);
...
if(mario.isTouching(birdG)||mario.isTouching(pipeG)){
  gameState=END;
}
...
function spawnPipe() {
  //write code here to spawn the clouds
  if (frameCount % 170 === 0) {
     pipe = createSprite(700,315,40,10);
    pipe.debug=true
    pipe.setCollider("rectangle",0,0,20,pipe.height);
